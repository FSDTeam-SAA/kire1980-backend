...
export class CreateUserDto {
  ...
  @ApiProperty({ example: 'United States', description: 'User country', required: false })
  @IsString()
  @IsOptional()
  country?: string;
  ...
  @ApiProperty({ example: 'Technology', description: 'User sector', required: false })
  @IsString()
  @IsOptional()
  sector?: string;
  ...
  @ApiProperty({ example: 'customer', description: 'User role', enum: UserRole, default: 'customer', required: false })
  ...
  @ApiProperty({ example: '507f1f77bcf86cd799439012', description: 'Business ID reference', required: false })
  @IsString()
  @IsOptional()
  businessId?: string;
